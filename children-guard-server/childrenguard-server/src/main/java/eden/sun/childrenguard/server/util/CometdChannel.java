...
public class CometdChannel {

	public static final String LOGIN = "/service/login";
	public static final String REGISTER = "/service/register";
	public static final String PASSWORD_RESET = "/service/passwordReset";
	public static final String IS_FIRST_LOGIN = "/service/isFirstLogin";
